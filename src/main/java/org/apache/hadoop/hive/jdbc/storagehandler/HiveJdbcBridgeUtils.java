...
public class HiveJdbcBridgeUtils {
	...
	public static Object readObject(DataInput in, int sqlType)
			throws IOException {
		switch (sqlType) {
		case Types.VARCHAR:
			return in.readUTF();
	...
	public static void writeObject(Object obj, int sqlType, DataOutput out)
			throws IOException {
		switch (sqlType) {
		case Types.VARCHAR: {
		...
		default:
			throw new IOException("Cannot write Object '"
					+ obj.getClass().getSimpleName() + "' as type: " + sqlType);
		}
	}
